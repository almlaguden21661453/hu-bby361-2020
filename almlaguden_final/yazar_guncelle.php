...
<form action="yazar_guncellendi.php" method="post">
    Yazar No: <input name="yazarKayitNo" value="<?php echo $satir["yazarKayitNo"] ;?>"><br><br>
	Yazar Adı: <input type="text" name="yazarAdi" value="<?php echo $satir["yazarAdi"] ;?>"><br><br>
    Yazar Soyadı: <input type="text" name="yazarSoyadi" value="<?php echo $satir["yazarSoyadi"] ;?>"><br><br>
    Yazar URL: <textarea name="yazarURL" rows="2" cols="50"><?php echo $satir["yazarURL"]?></textarea><br><br>
    <input type="hidden" value="<?php echo $satir["yazarKayitNo"] ;?>" name="yazarNo">
