<?php
    ...
    $sorgu2 = mysqli_query($baglanti, "SELECT * FROM yazar ORDER BY yazarKayitNo DESC");
...
while($satir = mysqli_fetch_assoc($sorgu2)){
    ...
    echo("<td> <a href='".$satir["yazarURL"]."' target='_blank'>Link </a></td>");
    echo("<td><a href='yazar_guncelle.php?yazarKayitNo=".$satir["yazarKayitNo"]."'>Güncelle</a></td>");
    echo("<td><a href='yazar_sil.php?yazarKayitNo=".$satir["yazarKayitNo"]."'>Sil</a></td>");
    echo("</tr>");
            }
echo("</table>");
?>
