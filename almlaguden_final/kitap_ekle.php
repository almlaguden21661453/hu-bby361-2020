...
<form action="kitap_eklendi.php" method="post">
    Kitap Adı: <input type="text" name="eserAdi"><br><br>
    Yazar: <input type="text" name=""><br><br>
    Kitap ISBN: <textarea name="eserISBN" rows="1" cols="50"></textarea><br><br>
    <input type="submit" value="Yeni Kitap Ekle">
</form>
<!-- KODLAR -->   
</main>
