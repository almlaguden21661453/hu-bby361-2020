<?php
    ...
    $eserKayitNo = mysqli_real_escape_string($baglanti, $_POST['eserKayitNo']);    
    $eserAdi = mysqli_real_escape_string($baglanti, $_POST['eserAdi']);
    $eserISBN = mysqli_real_escape_string($baglanti, $_POST['eserISBN']);
    $sorgu = "UPDATE kitap SET eserAdi = '$eserAdi', eserISBN = '$eserISBN' WHERE eserKayitNo = $eserKayitNo";
    ...
    $sorgu2 = mysqli_query($baglanti,"SELECT K.*, Y.*, YA.*  FROM kitap K, yayinevi Y, yazar YA WHERE K.yazarNo= YA.yazarKayitNo
