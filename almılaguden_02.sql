...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 06 Ara 2020, 21:31:12
...
INSERT INTO `kitap` (`Kitapkayittarihi`, `KitapNo`, `ISBN`, `KitapAdi`, `KitabinBasimYeri`, `KitabinBasimyili`, `KitabinBskbilgisi`, `Kitabindili`, `Hangiyoreyeait`, `Yazarkayitno`, `Yayinevikayitno`) VALUES
...
CREATE TABLE `yayinevi` (
  ...
  `Yayinevitelefon` int(11) DEFAULT NULL COMMENT 'Yayınevine ait telefon numarası başında "0" bulunmadan yer almaktadır.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `yazar`
  MODIFY `Yazarkayitno` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Yazarın sisteme kayıt alırken verilen numara. numarası.', AUTO_INCREMENT=8;
--
...
('root', '[{\"db\":\"almlaguden_01\",\"table\":\"liste\"},{\"db\":\"almlaguden_01\",\"table\":\"yazar\"},{\"db\":\"almlaguden_01\",\"table\":\"yayinevi\"},{\"db\":\"almlaguden_01\",\"table\":\"kitap\"},{\"db\":\"almlaguden_01\",\"table\":\"kitaplar\"},{\"db\":\"almlaguden_01\",\"table\":\"g\\u00f6r\\u00fcn\\u00fcmler\"},{\"db\":\"almlaguden_01\",\"table\":\"Kitap\"}]');
...
('root', '2020-12-06 20:30:50', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"tr\"}');
