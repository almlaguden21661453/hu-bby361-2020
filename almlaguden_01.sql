...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 06 Kas 2020, 12:20:45
...
INSERT INTO `kitap` (`Kitapkayittarihi`, `kitapNo`, `ISBN`, `KitapAdi`, `KitabinBasimYeri`, `KitabinBasimyili`, `KitabinBskbilgisi`, `Kitabindili`, `Hangiyöreyeait`) VALUES
('22:09:52', 1, '9786054232253', '81 İl 81 Ünlü  81 Yemek', 'Ankara', 2009, NULL, 'Türkçe', 'Türkiye'),
('22:10:12', 2, '9786051069470', 'Doğu Anadolu Yemekleri', 'İstanbul', 2015, NULL, 'Türkçe', 'Doğu Anadolu'),
('22:10:31', 3, '9789755216348', 'Akdeniz Yemekleri : pratik mutfak rehberi', 'İstanbul', 2006, NULL, 'türkçe', 'Akdeniz'),
('22:11:36', 4, '9789750821745', 'İstanbul Rumlarından Yemek Tarifleri', 'İstanbul', 2012, NULL, 'Türkçe', 'Marmara'),
('22:11:36', 5, '9786051069487', 'Güneydoğu Anadolu Yemekleri', 'İstanbul', 2015, NULL, 'Türkçe', 'Güneydoğu Anadolu'),
('22:11:36', 6, '9789751413918', 'Antakya ve Yemekleri', 'İstanbul ', 2010, NULL, 'Türkçe ', 'Akdeniz'),
('22:11:36', 7, '9786056170935', 'Anadolu Yemekleri Ve Türk Mutfağı', 'İstanbul', 2011, 2, 'Türkçe', 'Türkiye'),
('22:11:36', 8, '9789757375326', 'Dört mevsim Gaziantep yemekleri', 'Gaziantep ', 2003, NULL, 'Türkçe', 'Güneydoğu Anadolu'),
('22:11:36', 9, '9786051069500', 'Soframda Anadolu Karadeniz Yemekleri', 'İstanbul ', 2015, NULL, 'türkçe', 'Karadeniz'),
('22:11:36', 10, '9789755852669', 'ELAZIĞ / HARPUT YÖRESEL YEMEKLERİ', 'Elazığ', 2002, NULL, 'Türkçe', 'Doğu Anadolu ');
...
CREATE TABLE `yayinevi` (
  `yayinevino` int(100) NOT NULL COMMENT 'yayınevi numarası yer almaktadır.',
...
INSERT INTO `yayinevi` (`yayinevino`, `yayıneviadi`, `yayıneviadresi`, `yayınevieposta`, `yayinevitelefon`) VALUES
...
CREATE TABLE `yazar` (
  `yazarno` int(11) NOT NULL COMMENT 'Yazar ıd numarası.',
...
INSERT INTO `yazar` (`yazarno`, `yazaradi`, `yazarsoyadi`, `yazaradisoyadi`) VALUES
...
--
ALTER TABLE `yayinevi`
  MODIFY `yayinevino` int(100) NOT NULL AUTO_INCREMENT COMMENT 'yayınevi numarası yer almaktadır.', AUTO_INCREMENT=8;
COMMIT;
